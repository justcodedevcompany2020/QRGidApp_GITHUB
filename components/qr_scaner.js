        ...
        if (data_arr.length == 2) {
            ...
            if (data_arr[0] == 'https://qr-gid.by/api/by/detail/?'  || data_arr[0] == 'https://qr-gid.by/api/detail/?' || data_arr[0] == 'https://qr-gid.by/api/en/detail/?')  {
                    ...
                    if (status !== 'granted') {
                        ...
                        setShowLocationRequiredText(true)
    ...
    return (
        <SafeAreaView style={styles.container}>
                    ...
                    <TouchableOpacity
                        ...
                        {Platform.OS === 'ios' &&
                            <Svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 24 24" fill="none">
                                <Path fillRule="evenodd" clipRule="evenodd" d="M6 3a1 1 0 00-1 1H4a3 3 0 00-3 3v10a3 3 0 003 3h16a3 3 0 003-3V7a3 3 0 00-3-3H8a1 1 0 00-1-1H6zM4 5a2 2 0 00-2 2v2a3 3 0 013 3v7h15a2 2 0 002-2V7a2 2 0 00-2-2H4zm5.5 7a4.5 4.5 0 118.626 1.8.5.5 0 10.916.4 5.5 5.5 0 10-10.391-.917l-1.025-.267a.5.5 0 00-.252.968l1.916.5.33.086.201-.277 1.084-1.5a.5.5 0 00-.81-.586l-.504.697A4.524 4.524 0 019.5 12zm7.8 4.4a.5.5 0 00-.6-.8c-.752.566-1.686.9-2.7.9a.5.5 0 000 1c1.238 0 2.381-.41 3.3-1.1z" fill="#393840"/>
                            </Svg>
                        }
            ...
            {scanned &&
                ...
                <View style={{backgroundColor:'transparent', zIndex:222}}>
                    <TouchableOpacity
                        style={{backgroundColor: '#FF9161', padding:10, borderRadius:5, zIndex: 666}}
                   ...
                   {show_location_required_text &&

                        <TouchableOpacity style={{padding:10, borderRadius:5, zIndex: 666}} title={'Tap to Scan Again'}
                          onPress={() => {

                          }}
                        >
                            <Text style={{color:'red', width: 150, fontSize:11}}>
                                {/*Сканировать еще раз*/}
                                {language.location_required_text}
                            </Text>
                        </TouchableOpacity>
            ...
            {show_loader_after_scan &&

                <View style={styles.showLoaderAfterScan}>
